...
start "Gold Price Predictor - Backend" cmd /k "cd /d %~dp0backend && (if exist venv\Scripts\uvicorn.exe (venv\Scripts\uvicorn.exe main:app --host 0.0.0.0 --port 8000 --reload) else (uvicorn main:app --host 0.0.0.0 --port 8000 --reload))"
